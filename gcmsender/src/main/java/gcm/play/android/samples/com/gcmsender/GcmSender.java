...
public class GcmSender {
    //public static final String API_KEY = "AIzaSyArW-8DUgBsFiXLJtfGZc9acDUH2TnnN_I";
    public static final String API_KEY = "AIzaSyAYTgxverAoTYQtLZAkaeqyPs9HfLB0DM8";
    public static final String device_token="empPm-Sivz4:APA91bEFVGJw-FONYIuT6u5vvUVwr23xoRKbEZdNmOXnKaCq6BnfkLnC8tfM8oIU0iBdCQ2t9g6N5pJ1ZupFB8bsvgatB6SzGitJdSp4jXDakEaDrCr31wQFugLG-3Bh0BkUzfmGwv1b";
    ...
    public static void main(String[] args) {
       /* if (args.length < 1 || args.length > 2 || args[0] == null) {
        ...
        try {
            ...
            try {
                jData.put("message", "welcome to fanwish");
